...
do_enrichmap = function(M,cutHeight,topN,database,flag_cluster_col=TRUE,flag_p=FALSE,path_to_databasefiles='~/Codes_for_manuscript_outputs/InPut_datasets/'){
...
if (database=='GOBP'){
gmt <- clusterProfiler::read.gmt (paste(path_to_databasefiles,"c5.go.bp.v2022.1.Hs.symbols.gmt",sep=""))
}
if (database=='Pathways'){  
gmt <- clusterProfiler::read.gmt (paste(path_to_databasefiles,"c2.cp.v2022.1.Hs.symbols.gmt",sep=""))
}
